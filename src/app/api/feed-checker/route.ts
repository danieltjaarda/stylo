...
<head>
    ...
    <title>Google Feed Checker - DESKNA</title>
...
<body>
    <div class="container">
        ...
        <div>
            <button onclick="checkFeed()">🔍 Feed Controleren</button>
            <button onclick="openFeedInNewTab()" class="secondary">📄 Feed Bekijken</button>
            <button onclick="downloadFeed()" class="secondary">⬇️ Feed Downloaden</button>
        </div>
    ...
    <div class="container">
        ...
        <div id="validation-results" class="validation-checklist">
            <div class="info">Klik op "Feed Controleren" om de validatie te starten...</div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="external-links">
            <a href="https://www.google.com/merchants/" target="_blank" class="link-card">
                <div class="link-title">Google Merchant Center</div>
                <div class="link-desc">Upload je feed hier en controleer de status</div>
            </a>
            <a href="https://support.google.com/merchants/answer/7052112" target="_blank" class="link-card">
                <div class="link-title">Google Feed Specificaties</div>
                <div class="link-desc">Officiële documentatie voor productfeeds</div>
            </a>
            <a href="https://developers.google.com/shopping-content/guides/products/feed-format" target="_blank" class="link-card">
                <div class="link-title">Feed Format Guide</div>
                <div class="link-desc">Technische specificaties en voorbeelden</div>
            </a>
            <a href="https://www.feedvalidator.org/" target="_blank" class="link-card">
                <div class="link-title">Feed Validator</div>
                <div class="link-desc">Online XML feed validator tool</div>
            </a>
        </div>
    </div>
            ...
            try {
                ...
                statsDiv.innerHTML = \`
                    <div class="stats">
                        ...
                        <div class="stat-box">
                            <div class="stat-number">\${stats.feedSize}KB</div>
                            <div class="stat-label">Feed Grootte</div>
                        </div>
                        <div class="stat-box">
                        ...
                        <div class="stat-box">
                            <div class="stat-number">\${stats.uniqueCategories.length}</div>
                            <div class="stat-label">Categorieën</div>
                        </div>
                        <div class="stat-box">
                            <div class="stat-number">\${validation.summary.validItems}/\${validation.summary.totalItems}</div>
                            <div class="stat-label">Geldige Items</div>
                        </div>
                        <div class="stat-box">
